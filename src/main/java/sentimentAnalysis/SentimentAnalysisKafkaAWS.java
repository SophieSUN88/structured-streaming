...
public class SentimentAnalysisKafkaAWS {

    final String INPUT_TOPIC = "twitter";
    final String OUTPUT_TOPIC = "sentiment-analysis-result";
    final String BOOTSTRAP_SERVERS = "b-3.lab4-kafka.ffx3bg.c3.kafka.us-east-2.amazonaws.com:9092";
    ...
    public void run() throws StreamingQueryException {
        ...
        //update模式
        StreamingQuery query = analysisReport
                .select(functions.concat(
                        functions.col("key_word"),functions.lit(','),
                        functions.col("sentiment"),functions.lit(','),
    ...
    public static void main(String[] args) throws StreamingQueryException {
        new SentimentAnalysisKafkaAWS().run();
    }
}
